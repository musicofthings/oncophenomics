    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark font-display">
      ...
      <div className="max-w-4xl mx-auto px-6 py-32">
        ...
        <div className="space-y-6">
          <div className="flex gap-6 p-6 rounded-2xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <div>
              <h3 className="text-xl font-bold mb-1 text-slate-900 dark:text-white">Robust REST API</h3>
          ...
          <div className="flex gap-6 p-6 rounded-2xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <div>
              <h3 className="text-xl font-bold mb-1 text-slate-900 dark:text-white">HL7 & FHIR Support</h3>
          ...
          <div className="flex gap-6 p-6 rounded-2xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <div>
              <h3 className="text-xl font-bold mb-1 text-slate-900 dark:text-white">Webhooks & Notifications</h3>
